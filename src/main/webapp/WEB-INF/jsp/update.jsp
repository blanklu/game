    ...
    <form onsubmit="return false;">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="title" lay-filter="demo" autocomplete="off" class="layui-input" value="${articlemess.title}">
            </div>
            <label for="title" class="layui-form-label">
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea placeholder="请输入文章内容" id="hah" name="sellPoint" class="layui-textarea" style="height: 300px">${articlemess.content}</textarea>
            </div>
        </div>
...
<script>
    ...
    layui.use(['table','element','form','jquery'], function() {
        ...
        $("#add").on('click',function () {
            ...
            var article_id = ${articlemess.article_id};
